...
setSeed(18, 7 , { beadType: 0, index : -3, bondNum : 0 } );
setSeed(19, 7 , { beadType: 0, index : -3, bondNum : 0 } );
...
//start point
setSeed(39, 8 , { beadType: 89, index : -3, bondNum : 0 } );//start points +0
setSeed(40, 10 , { beadType: 0, index : -3, bondNum : 0 } );//start points +1
